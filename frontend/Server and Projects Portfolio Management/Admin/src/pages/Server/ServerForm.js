...
const ServerForm = () => {
  ...
  function handleSubmit(e) {
    ...
    axiosAPI.post("http://localhost:5000/api/add-server", data).then((response)=>{
        console.log(response.data)
    })
    window.location.href = "/server1";
                      ...
                      <Col md="6">
                        <div className="mb-3">
                          ...
                          <AvField
                            ...
                            onChange={(e)=>setData({...data,vm_name:e.target.value})}
                          />
                        </div>
                      </Col>
                      <Col md="6">
                      ...
                      <Col md="4">
                        <div className="mb-3">
                          ...
                          <AvField
                            ...
                            // validate={{ required: { value: true } }}
                            id="validationCustom03"
                            onChange={(e)=>setData({...data,vcpu:e.target.value})}
                          />
                        </div>
                      </Col>
                      <Col md="4">
                        <div className="mb-3">
                          ...
                          <AvField
                            ...
                            // validate={{ required: { value: true } }}
                            id="validationCustom04"
                            onChange={(e)=>setData({...data,public:e.target.value})}
                      ...
                      <Col md="4">
                        <div className="mb-3">
                          ...
                          <AvField
                            ...
                            // validate={{ required: { value: true } }}
                            id="validationCustom05"
                            onChange={(e)=>setData({...data,private:e.target.value})}
